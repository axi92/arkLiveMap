...
for (i = 0; i < fLen; i++) {
  ...
  // var m = L.marker([100-mark[i][0], mark[i][1]], {icon: L.AwesomeMarkers.icon({icon: mark[i][2], prefix: 'fa', markerColor: mark[i][3] }) }).addTo(map).bindPopup(mark[i][4] + '<br />' + mark[i][0].toFixed(1) + ' / ' + mark[i][1].toFixed(1));
